$(document).ready(function() {
    // alert('#imToken# #5241# 我们正在完善 KAR 在 imToken 中的代币相关资料。完成后，大家可以在 imToken 里看到 logo，更方便地管理 KAR，同时能看到更多代币信息。')
    //copy
    ...
    setInterval(function () {
        ...
        days_span.innerHTML = '<span class="number">' + days + '</span>' + '<span class="unit">天</span>';
        hours_span.innerHTML = '<span class="number">' + hours + '</span>' + '<span class="unit">小時</span>';
